...
const experiences = [
  ...
  },
  {
    ...
    note: 'Please allow a couple of minutes for backend and DB to run',
    gitUrl: 'https://github.com/fabio-writes-code/community_delivery',
    liveUrl: 'https://delivy.onrender.com/',
    points: [
      "Designed and Developed a back-end API using Django and Django Rest Framework",
      "Designed and deployed a PostgreSQL and PostGIS database system using Django ORM and GeoDjango",
      "Designed and developed a user friendly front-end using Mapbox's API, HTML, CSS, JavaScript and Django's templating engine",
      "Deployed database to Azure, API and Front-end to Render",
    ],
  },
  {
    title: "Web Design and Development",
    image: nativeTeachers,
    project_name: "Native Teachers",
    icon: web,
    icons: [
      'devicon-react-original',
